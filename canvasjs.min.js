...
(function() {
    ...
    function qa(a) { a.indexOf || (a.indexOf = Ra);
        return a }
    ...
    function ra(a, d, b) {
        if (u && Ma) {
            ...
            a.width = d * Q;
            a.height = b * Q;
            za !== sa && (a.style.width = d + "px", a.style.height = b + "px", c.scale(Q, Q)) } else a.width = d, a.height = b }
    ...
    function ja(a, d, b, c, f) { "undefined" === typeof f && (f = 0);
        this._padding = f;
        this._x1 = a;
        this._y1 = d;
        this._x2 = b;
    ...
    function va(a, d) { va.base.constructor.call(this, "Subtitle", d, a.theme, a);
        this.chart = a;
        this.canvas = a.canvas;
        this.ctx = this.chart.ctx;
    ...
    var z = {},
        ...
        pa = { en: {} },
        ha = { colorSet1: "#369EAD #C24642 #7F6084 #86B402 #A2D1CF #C8B631 #6DBCEB #52514E #4F81BC #A064A1 #F79647".split(" "), colorSet2: "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #33558B".split(" "), colorSet3: "#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ") },
        ia = {
            theme1: {
            ...
            for (q = l = v = e = k = 0; 0 < m.length;)
                if (d = m.pop(), "#" === d || "0" === d)
                    if (k++, k === p) {
                        ...
                        for (; 0 < w.length;) b = w.pop() + b, q++, 0 === q % l && (v === r && 0 < w.length) && (b = g + b) } else 0 < h.length ? (b = h.pop() + b, e++, q++) : "0" === d && (b = "0" + b, e++, q++), 0 === q % l && (v === r && 0 < h.length) && (b = g + b);
            ...
            if (!Aa) try {
                ...
                a: {
                    ...
                    if (f && 0 < f.length || g) {
                        ...
                        if (2592E6 < Math.round(Math.abs(g - c.getTime()))) { d = !0;
                            break a } } else {
                        l = new Date;
                        k = l.getTime();
                        l.setTime(k + 31536E6);
    ...
    M.prototype.addEventListener =
        function(a, d, b) { a && d && (this._eventListeners[a] = this._eventListeners[a] || [], this._eventListeners[a].push({ context: b || this, eventHandler: d })) };
    ...
    A.prototype._updateOptions = function() {
        ...
        this.options.zoomEnabled ?
            (this._zoomButton || (Y(this._zoomButton = document.createElement("button")), T(this, this._zoomButton, "pan"), this._toolBar.appendChild(this._zoomButton), K(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, T(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, T(a, a._zoomButton, "pan"));
                a.render() })), this._resetButton || (Y(this._resetButton = document.createElement("button")), T(this, this._resetButton, "reset"), this._toolBar.appendChild(this._resetButton), K(this._resetButton,
                "click",
                function() {
                    a.toolTip.hide();
        ...
        if (!this._dropdownMenu && this.exportEnabled && u) {
            ...
            K(d, "mouseover", function() { this.style.backgroundColor = "#EEEEEE" }, !0);
            K(d, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            K(d, "click", function() { Ba(a.canvas, "jpeg", a.exportFileName);
                Y(a._dropdownMenu) }, !0);
            d = document.createElement("div");
            d.style.cssText = "padding: 2px 15px 2px 10px";
            ...
            K(d, "mouseout", function() { this.style.backgroundColor = "transparent" }, !0);
            K(d, "click", function() { Ba(a.canvas, "png", a.exportFileName);
                Y(a._dropdownMenu) }, !0)
        }
            ...
            for (var d = 0; d < this.options.data.length; d++)
                if (a++, !this.options.data[d].type || 0 <= A._supportedChartTypes.indexOf(this.options.data[d].type)) {
                    ...
                    "bubble" !== b.type && "scatter" !== b.type || !b.dataPoints || (b.dataPoints.some ? b.dataPoints.some(function(a) {
                        return a.x }) && b.dataPoints.sort(Ia) : b.dataPoints.sort(Ia));
                    this.data.push(b);
                ...
                for (k = 0; k < l.dataPoints.length; k++) {
                    ...
                    if (0 < k) {
                        if (a.axisX.logarithmic) {
                            ...
                            1 > q && (q = 1 / q);
                            b.minDiff > q && 1 !== q && (b.minDiff = q) } else q = c - l.dataPoints[k -
            ...
            if (!(b && 1 < b.length)) {
                ...
                try {
                    ...
                    if (15 < Math.abs(g) && (this._lastTouchData.scroll || 200 > h)) { this._lastTouchData.scroll = !0;
                        ...
                        l && l.scrollBy && l.scrollBy(0, -g) } } catch (k) {}
        ...
        for (g = 0; g < m.length; g++) {
            ...
            if (isFinite(h.dataInfo.minDiff))
                if (!(h.logarithmic && e / p < Math.pow(h.dataInfo.minDiff, 3) || !h.logarithmic && Math.abs(e - p) < 3 * Math.abs(h.dataInfo.minDiff) ||
                        p < h.minimum || e > h.maximum)) k.push(h), n.push({ val1: p, val2: e }), l = !0;
                else if (!f) { l = !1;
                break }
        }
        ...
        for (a = 0; a < this._indexLabels.length; a++) {
            ...
            if (null !== t && "" !== t) {
                var w = L("indexLabelPlacement", m.dataPoint, m.dataSeries),
                    ...
                    z = !1,
                    r = new W(d, { x: 0, y: 0, maxWidth: f ? f : 0.5 * this.width, maxHeight: g ? 5 * k : 1.5 * k, angle: "horizontal" === y ? 0 : -90, text: t, padding: 0, backgroundColor: r, horizontalAlign: "left", fontSize: k, fontFamily: p, fontWeight: h, fontColor: l, fontStyle: e, textBaseline: "top" });
                r.measureText();
                m.dataSeries.indexLabelMaxWidth =
                    r.maxWidth;
                if (0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("bubble") || 0 <= n.indexOf("scatter")) {
                    if (m.dataPoint.x < Z.viewportMinimum || m.dataPoint.x > Z.viewportMaximum || m.dataPoint.y < aa.viewportMinimum || m.dataPoint.y > aa.viewportMaximum) continue } else if (0 <= n.indexOf("column")) {
                        ...
                        if (v = k[s].x.getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || q) && (d.stroke(), u && b.stroke()), y = !0;
                                ...
                                if (0 < k[s].markerSize || 0 < l.markerSize) {
                                    ...
                                    c.push(D);
                                    t = G(t);
                                    u && c.push({ x: v, y: w, ctx: b, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness }) }(k[s].indexLabel || l.indexLabel || k[s].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({ chartType: "line", dataPoint: k[s], dataSeries: l, point: { x: v, y: w }, direction: 0 > k[s].y === a.axisY.reversed ? 1 : -1, color: e })
                            }
                    d.stroke();
                    u && b.stroke()
                }
                    ...
                    for (var y = !1, s = 0; s < k.length; s++)
                        if (v = k[s].getTime ? k[s].x.getTime() : k[s].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!l.connectNullData || !y)))
                            if ("number" !== typeof k[s].y) 0 < s && !(l.connectNullData || y || q) && (d.stroke(), u && b.stroke()), y = !0;
                                ...
                                if (0 < k[s].markerSize || 0 < l.markerSize) t = l.getMarkerProperties(s, v, w, d), f = t.color, c.push(t), D = G(D), u && c.push({ x: v, y: w, ctx: b, type: t.type, size: t.size, color: D, borderColor: D, borderThickness: t.borderThickness });
                        ...
                        if (v = m[s].getTime ? m[s].x.getTime() : m[s].x, !(v < a.axisX.dataInfo.viewPortMin ||
                            ...
                            if ("number" !== typeof m[s].y) 0 < s && !w && (k.connectNullData ? b.setLineDash && (0 < y.length && (k.options.nullDataLineDashType || !m[s - 1].lineDashType)) && (y[y.length - 1].newLineDashArray = p, n = k.nullDataLineDashType) : (d(y), y = [])), w = !0;
                                ...
                                if (0 < m[s].markerSize || 0 < k.markerSize) {
                                    ...
                                    f.push(D);
                                    t = G(t);
                                    u && f.push({ x: v, y: w, ctx: c, type: D.type, size: D.size, color: t, borderColor: t, borderThickness: D.borderThickness }) }(m[s].indexLabel ||
                                    k.indexLabel || m[s].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: m[s], dataSeries: k, point: { x: v, y: w }, direction: 0 > m[s].y === a.axisY.reversed ? 1 : -1, color: r });
                                w = !1
                            }
                d(y)
            }
                    ...
                    for (l = 0; l < q.length; l++)
                        if (b = q[l].x.getTime ? q[l].x.getTime() :
                            ...
                            if (a.axisY.logarithmic) h[b] = q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (k = a.axisY.convertValueToPixel(h[b]), y = f[b] ? f[b] : m, f[b] = k);
                                ...
                                k -= t;
                                y = m - t;
                                f[b] = t + (y - k) } else t = g[b] ? g[b] : 0, y = k + t, k = m + t, g[b] = t + (y - k);
                ...
                if (0 < q.length)
                    for (var s = 5 < p && r.bevelEnabled ? !0 : !1, l = 0; l < q.length; l++)
                        if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                            ...
                            u && N(this._eventManager.ghostCtx, v, k, w, y, b, 0, null, !1, !1, !1, !1);
                            (q[l].indexLabel ||
                                r.indexLabel || q[l].indexLabelFormatter || r.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn100", dataPoint: q[l], dataSeries: r, point: { x: c, y: 0 <= q[l].y ? k : y }, direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: v, y1: Math.min(k, y), x2: w, y2: Math.max(k, y) }, color: b })
                        }
            }
            d.restore();
            u && this._eventManager.ghostCtx.restore();
                    ...
                    for (l = 0; l < q.length; l++)
                        if (b = q[l].x.getTime ? q[l].x.getTime() :
                            ...
                            if (a.axisY.logarithmic) h[b] = q[l].y + (h[b] ? h[b] : 0), 0 < h[b] && (y = f[b] ? f[b] : m, f[b] = k = a.axisY.convertValueToPixel(h[b]));
                                ...
                                y = m + t;
                                k += t;
                                f[b] = t + (k - y) } else t = g[b] ? g[b] : 0, y = k - t, k = m - t, g[b] = t + (k - y);
                            b = q[l].color ? q[l].color : r._colorSet[l % r._colorSet.length];
                    ...
                    for (l = 0; l < q.length; l++)
                        if (b = q[l].x.getTime ? q[l].x.getTime() : q[l].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[l].y) {
                            ...
                            var w = c - a.plotType.plotUnits.length * p / 2 + a.index * p << 0,
                                y = w + p << 0;
                            if (a.axisY.logarithmic) { h[b] = v + (h[b] ? h[b] : 0);
                                if (0 >= h[b]) continue;
                                v = f[b] ? f[b] : m;
                                f[b] = k = a.axisY.convertValueToPixel(h[b]) } else if (k =
                                a.axisY.convertValueToPixel(v), 0 <= q[l].y) {
                                var t = f[b] ? f[b] : 0;
                                v = m + t;
                                k += t;
                                f[b] = t + (k - v) } else t = g[b] ? g[b] : 0, v = k - t, k = m - t, g[b] = t + (k - v);
                            b = q[l].color ? q[l].color : r._colorSet[l % r._colorSet.length];
                            ...
                            this._indexLabels.push({ chartType: "stackedBar100", dataPoint: q[l], dataSeries: r, point: { x: 0 <= q[l].y ? k : v, y: c }, direction: 0 > q[l].y === a.axisY.reversed ? 1 : -1, bounds: { x1: Math.min(v, k), y1: w, x2: Math.max(v, k), y2: y }, color: b })
                        }
                }
            }
            d.restore();
    ...
    A.prototype.renderArea = function(a) {
        function d() {
            t && (0 < n.lineThickness &&
                b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(), b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, u && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = { x: q, y: s })
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx,
                    ...
                    for (var J = !0; r < p.length; r++)
                        if (v = p[r].x.getTime ? p[r].x.getTime() : p[r].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !J)))
                            if ("number" !== typeof p[r].y) n.connectNullData ||
                                ...
                                e || J ? (!e && n.connectNullData ? (b.setLineDash && (n.options.nullDataLineDashType || z === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (b.stroke(), z = n.nullDataLineDashType, b.setLineDash(A)), b.lineTo(q, s), u && c.lineTo(q, s)) : (b.beginPath(), b.moveTo(q, s), u && (c.beginPath(), c.moveTo(q, s)), t = { x: q, y: s }), J = e = !1) : (b.lineTo(q, s), u && c.lineTo(q, s), 0 == r % 250 && d());
                            ...
                            if (r = p[e].x.getTime ? p[e].x.getTime() : p[e].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !q)))
                                if ("number" !== typeof p[e].y) 0 < e && !q && (n.connectNullData ? b.setLineDash && (0 < y.length && (n.options.nullDataLineDashType || !p[e - 1].lineDashType)) && (y[y.length - 1].newLineDashArray =
                                    ...
                                    if (0 !== p[e].markerSize && (0 < p[e].markerSize || 0 < n.markerSize)) {
                                        ...
                                        h.push(J);
                                        R = G(R);
                                        u && h.push({ x: r, y: q, ctx: c, type: J.type, size: J.size, color: R, borderColor: R, borderThickness: J.borderThickness }) }(p[e].indexLabel || n.indexLabel || p[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({
    ...
    A.prototype.renderStepArea = function(a) {
        function d() {
            t && (0 < n.lineThickness && b.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? y = w : 0 > a.axisY.viewportMaximum ? y = g.y1 : 0 < a.axisY.viewportMinimum && (y = f.y2), b.lineTo(q, y), b.lineTo(t.x, y), b.closePath(),
                b.globalAlpha = n.fillOpacity, b.fill(), b.globalAlpha = 1, u && (c.lineTo(q, y), c.lineTo(t.x, y), c.closePath(), c.fill()), b.beginPath(), b.moveTo(q, s), c.beginPath(), c.moveTo(q, s), t = { x: q, y: s })
        }
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = this._eventManager.ghostCtx,
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!t.connectNullData || !J)))
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(),
                                ...
                                if (a.axisY.logarithmic) { n[q] = H.y + (n[q] ? n[q] : 0);
                                    if (0 >= n[q]) continue;
                                    r = a.axisY.convertValueToPixel(n[q]) } else r = a.axisY.convertValueToPixel(H.y), r -= ea;
                                k.push({ x: e, y: s - ea });
                                l[q] = s - r;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || A === t.lineDashType && t.lineDashType !== t.nullDataLineDashType) && (b.stroke(), A = t.nullDataLineDashType, b.setLineDash(B)), b.lineTo(e, r), u && v.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), u && (v.beginPath(),
                                    v.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), u && v.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e, r), u && v.moveTo(e, r), k.push({ x: e, y: s - ea })));
                                p < D.length - 1 && (z !== (D[p].lineColor || x) || A !== (D[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), k.push({ x: e, y: s - ea }), z = D[p].lineColor || x, b.strokeStyle = z, b.setLineDash && (D[p].lineDashType ? (A = D[p].lineDashType, b.setLineDash(I(A, t.lineThickness))) : (A = t.lineDashType, b.setLineDash(R))));
                                if (0 <= t.dataPointIndexes[q]) {
                                    var fa = t.dataPointIds[t.dataPointIndexes[q]];
                                    this._eventManager.objectMap[fa] = { id: fa, objectType: "dataPoint", dataSeriesIndex: y, dataPointIndex: t.dataPointIndexes[q], x1: e, y1: r }
                                }
                                0 <= t.dataPointIndexes[q] && 0 !== H.markerSize && (0 < H.markerSize || 0 < t.markerSize) && (q = t.getMarkerProperties(t.dataPointIndexes[q], e, r, b), g = q.color, f.push(q), markerColor = G(fa), u && f.push({ x: e, y: r, ctx: v, type: q.type, size: q.size, color: markerColor, borderColor: markerColor, borderThickness: q.borderThickness }));
                    ...
                    for (var J = !0, p = 0; p < m.length; p++) {
                        ...
                        if (!(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax &&
                            ...
                            if ("number" !== typeof H.y) t.connectNullData || (J || w) || d(), J = !0;
                                ...
                                e = a.axisX.convertValueToPixel(q);
                                var fa = l[q] ? l[q] : 0;
                                if (a.axisY.logarithmic) { n[q] = ea + (n[q] ? n[q] : 0);
                                    if (0 >= n[q]) continue;
                                    r = a.axisY.convertValueToPixel(n[q]) } else r = a.axisY.convertValueToPixel(ea), r -= fa;
                                k.push({ x: e, y: s - fa });
                                l[q] = s - r;
                                w || J ? (!w && t.connectNullData ? (b.setLineDash && (t.options.nullDataLineDashType || B === t.lineDashType && t.lineDashType !==
                                    t.nullDataLineDashType) && (b.stroke(), B = t.nullDataLineDashType, b.setLineDash(E)), b.lineTo(e, r), u && v.lineTo(e, r)) : (b.beginPath(), b.moveTo(e, r), u && (v.beginPath(), v.moveTo(e, r))), J = w = !1) : (b.lineTo(e, r), u && v.lineTo(e, r), 0 == p % 250 && (d(), b.moveTo(e, r), u && v.moveTo(e, r), k.push({ x: e, y: s - fa })));
                                p < x.length - 1 && (A !== (x[p].lineColor || z) || B !== (x[p].lineDashType || t.lineDashType)) && (d(), b.beginPath(), b.moveTo(e, r), k.push({ x: e, y: s - fa }), A = x[p].lineColor || z, b.strokeStyle = A, b.setLineDash && (x[p].lineDashType ? (B = x[p].lineDashType,
                ...
                if (0 < m.length) {
                    ...
                    for (var n = 0, p = 0, c = 0; c < m.length; c++)
                        if (f = m[c].getTime ? f = m[c].x.getTime() : f = m[c].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[c].y) {
                            ...
                            d.globalAlpha =
                                1;
                            Math.sqrt((n - f) * (n - f) + (p - g) * (p - g)) < Math.min(e.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = k.dataPointIds[c], this._eventManager.objectMap[n] = { id: n, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: c, x1: f, y1: g }, n = G(n), u && P.drawMarker(e.x, e.y, this._eventManager.ghostCtx, e.type, e.size, n, n, e.borderThickness), (m[c].indexLabel || k.indexLabel || m[c].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                chartType: "scatter",
                                dataPoint: m[c],
                                dataSeries: k,
                                point: {
                    ...
                    for (var v = 5 < p && q.bevelEnabled ? !0 : !1, f = 0; f < s.length; f++)
                        if (s[f].getTime ? n = s[f].x.getTime() : n = s[f].x, !(n < a.axisX.dataInfo.viewPortMin ||
                            ...
                            var w = g - p / 2 << 0,
                                ...
                                x = 0 === t % 2 ? 0 : 0.5,
                                z = q.dataPointIds[f];
                            this._eventManager.objectMap[z] = { id: z, objectType: "dataPoint", dataSeriesIndex: r, dataPointIndex: f, x1: w, y1: h, x2: y, y2: l, x3: g, y3: k, x4: g, y4: m, borderThickness: t, color: c };
                            d.strokeStyle = c;
                            d.beginPath();
                            d.lineWidth = t;
                            ...
                            (s[f].indexLabel || q.indexLabel || s[f].indexLabelFormatter || q.indexLabelFormatter) && this._indexLabels.push({ chartType: q.type, dataPoint: s[f], dataSeries: q, point: { x: w + (y - w) / 2, y: a.axisY.reversed ? k : l }, direction: 1, bounds: { x1: w, y1: Math.min(l, k), x2: y, y2: Math.max(l, k) }, color: c })
                        }
            }
            d.restore();
            u && b.restore();
                    ...
                    for (var E = !0; e < n.length; e++)
                        if (v = n[e].x.getTime ? n[e].x.getTime() : n[e].x, !(v < a.axisX.dataInfo.viewPortMin || v > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !E)))
                            if (null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" ===
                                ...
                                p || E ? (m.connectNullData && !p ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (l[l.length - 1].newLineDashArray = B, z = m.nullDataLineDashType, b.setLineDash(A)), b.lineTo(r, q), u && c.lineTo(r, q), l.push({ x: r, y: s })) : (b.beginPath(), b.moveTo(r, q), w = { x: r, y: q }, l = [], l.push({ x: r, y: s }), u && (c.beginPath(), c.moveTo(r, q))), E = p = !1) : (b.lineTo(r, q), l.push({ x: r, y: s }), u && c.lineTo(r, q), 0 == e % 250 && d());
                                v = m.dataPointIds[e];
                                this._eventManager.objectMap[v] = { id: v, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: e, x1: r, y1: q, y2: s };
                                ...
                                if (0 !== n[e].markerSize && (0 < n[e].markerSize || 0 < m.markerSize)) {
                                    ...
                                    f.push(R);
                                    var J = G(v);
                                    u && f.push({ x: r, y: s, ctx: c, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness });
                                    R = m.getMarkerProperties(e, r, q, b);
                                    g = R.color;
                                    f.push(R);
                                    J = G(v);
                                    u && f.push({ x: r, y: q, ctx: c, type: R.type, size: R.size, color: J, borderColor: J, borderThickness: R.borderThickness }) }
                    ...
                    for (e = !1; n < m.length; n++)
                        if (p = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(p < a.axisX.dataInfo.viewPortMin || p > a.axisX.dataInfo.viewPortMax && (!k.connectNullData ||
                            ...
                            if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                ...
                                this._eventManager.objectMap[A] = { id: A, objectType: "dataPoint", dataSeriesIndex: l, dataPointIndex: n, x1: p, y1: e, y2: r };
                                q[q.length] = { x: p, y: e };
                                s[s.length] = { x: p, y: r };
                                ...
                                if (m[n].indexLabel || k.indexLabel || m[n].indexLabelFormatter || k.indexLabelFormatter) this._indexLabels.push({ chartType: "splineArea", dataPoint: m[n], dataSeries: k, indexKeyword: 0, point: { x: p, y: e }, direction: m[n].y[0] <= m[n].y[1] ? -1 : 1, color: v }), this._indexLabels.push({ chartType: "splineArea", dataPoint: m[n], dataSeries: k, indexKeyword: 1, point: { x: p, y: r }, direction: m[n].y[0] <= m[n].y[1] ? 1 : -1, color: v });
                                e = !1
            ...
            if (m && n) {
                for (var a = 0, b = 0, c = 0, d = 0, f = 0; f < n.length; f++) {
                    var g =
                        n[f],
                        h = m.dataPointIds[f],
                        l = { id: h, objectType: "dataPoint", dataPointIndex: f, dataSeriesIndex: 0 };
                    r.push(l);
                    var p = { percent: null, total: null },
                        q = null,
                        p = k.getPercentAndTotal(m, g);
                    if (m.indexLabelFormatter || g.indexLabelFormatter) q = { chart: k.options, dataSeries: m, dataPoint: g, total: p.total, percent: p.percent };
                    ...
                    if (l.midAngle > Math.PI / 2 - w && l.midAngle < Math.PI / 2 + w) {
                        ...
                        a++ } else if (l.midAngle > 3 * Math.PI / 2 - w && l.midAngle < 3 * Math.PI / 2 + w) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            if (0 !== u) {
                ...
                var F = Math.min(E / B, (B -
                    1) / B);
                this.pieDoughnutClickHandler = function(a) { k.isAnimating || !x(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && k._animator.animate(0, 500, function(a) { b(a);
                        l() })) };
                d();
                h();
                h();
    ...
    ja.prototype.unRegisterSpace = function(a, d) { "top" === a ? this._topOccupied -= d.height : "bottom" === a ? this._bottomOccupied -= d.height : "left" === a ? this._leftOccupied -= d.width : "right" === a && (this._rightOccupied -= d.width) };
    ...
    ja.prototype.reset = function() { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding };
    U(W, M);
    ...
    W.prototype._getFontString = function() {
        ...
        var d = this.fontFamily ? this.fontFamily + "" : "";!u && d && (d = d.split(",")[0], "'" !== d[0] && '"' !== d[0] && (d = "'" + d + "'"));
        return a += d };
    U(ma, M);
    ...
    wa.prototype.render = function() {
            ...
            if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type) {
                ...
                for (var u = 0; u < p.dataPoints.length; u++) {
                    var t = p.dataPoints[u],
                        ...
                        r = t.legendText ? t.legendText : p.legendText ? p.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: t }) : t.name ? t.name : "DataPoint: " + (u + 1),
                        q =
                        ...
                        e = { markerType: e, markerColor: q, text: r, textBlock: null, chartType: p.type, markerSize: s, dataSeriesIndex: n, dataPointIndex: u, markerBorderColor: v, markerBorderThickness: w };
            ...
            for (n = 0; n < k.length; n++) {
                ...
                if (!(0 >= h || "undefined" === typeof h || 0 >= r || "undefined" === typeof r)) {
                    if ("horizontal" === this.orientation) {
                        ...
                        if (!p || p.width + Math.round(e.textBlock.width + s + l + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === e.chartType || "spline" === e.chartType || "stepLine" === e.chartType ? 2 * 0.1 * this.lineHeight : 0)) > g) p = { items: [], width: 0 }, m.push(p), this.height += u, u = 0;
        ...
        this.items = k;
        for (n = 0; n < this.items.length; n++) e = k[n], e.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[e.id] = { id: e.id, objectType: "legendItem", legendItemIndex: n, dataSeriesIndex: e.dataSeriesIndex, dataPointIndex: e.dataPointIndex };
                ...
                if (e) {
                    switch (this.type) {
                        ...
                        case "bubble":
                            s = e.size;
                            q = Math.sqrt(Math.pow(e.x1 - a, 2) + Math.pow(e.y1 - d, 2));
                            q <= s / 2 && (c.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: q }), l = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            s = e.center;
                        ...
                        case "candlestick":
                            if (a >= e.x1 - e.borderThickness / 2 && a <= e.x2 + e.borderThickness / 2 && d >= e.y2 - e.borderThickness / 2 && d <=
                                e.y3 + e.borderThickness / 2 || Math.abs(e.x2 - a + e.x1 - a) < e.borderThickness && d >= e.y1 && d <= e.y4) c.push({ dataPoint: r, dataPointIndex: g, dataSeries: this, distance: Math.min(Math.abs(e.x1 - a), Math.abs(e.x2 - a), Math.abs(e.y2 - d), Math.abs(e.y3 - d)) }), l = !0;
                            break;
                        case "ohlc":
    ...
    B.setLayoutAndRender = function(a, d, b, c, f, g) {
        ...
        if ("normal" === f) {
            ...
            for (; 4 > r;) {
                ...
                if (b && 0 < b.length)
                    for (e = 0; e < b.length; e++) C = 10, b[e] && (h = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = b[e]._labels && 0 < b[e]._labels.length ? b[e]._labels[b[e]._labels.length - 1].textBlock.height / 2 : 10, l = Math.round(g.y1 + V + L < Math.max(C, 10) ? Math.max(C, 10) : g.y1 + V + L), k = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), C = 0 < a.length ? 0 : b[e]._labels[0].textBlock.height / 2, m = Math.round(g.y2 - X - f - C), b[e].lineCoordinates = {
                        ...
                        height: Math.abs(m -
                            l)
                    }, b[e].bounds = { x1: h - (u[e] + P), y1: l, x2: k, y2: m, width: k - h, height: m - l }, b[e].title && (b[e]._titleTextBlock.maxWidth = 0 < b[e].titleMaxWidth && b[e].titleMaxWidth < b[e].lineCoordinates.height ? b[e].titleMaxWidth : b[e].lineCoordinates.height), P += u[e] + b[e].margin);
                if (c && 0 < c.length)
            ...
            for (; 4 > r;) {
                ...
                if (c && 0 < c.length)
                    for (e = c.length - 1; 0 <= e; e--) c[e] && (l = Math.round(g.y1), m = Math.round(g.y1 + (A[e] + c[e].margin + Q)), c[e].lineCoordinates.y1 = m, c[e].lineCoordinates.y2 = m, c[e].bounds = { x1: h, y1: l + (c[e].margin + Q), x2: k, y2: m, width: k - h, height: U }, c[e].title && (c[e]._titleTextBlock.maxWidth = 0 <
                ...
                if (d && 0 < d.length)
                    for (e = 0; e < d.length; e++) {
                        ...
                        d[e].lineCoordinates = { x1: k + P, y1: l, x2: k + P, y2: m, height: Math.abs(m - l) };
            ...
            if ("bottom" === this._position || "top" === this._position)
                if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                    for (var d = [], c = 0 !== this.labelAngle &&
                            360 !== this.labelAngle ? 1 : 1.2, g, h = this.viewportMaximum, l = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) { n = this._labels[k];
    ...
    B.prototype.renderStripLinesOfThicknessType = function(a) {
        if (this.stripLines && 0 < this.stripLines.length && a) {
            ...
            if (!h) {
                ...
                this.ctx.clip();
                for (c = 0; c < l.length; c++) m = l[c], m.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() { this.ctx.save();
                    this.ctx.beginPath();
            ...
            if (h)
                for (h = !1, c = 0; c < k.length; c++) b = k[c], b.stripLine.showOnTop ?
                    h || (h = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (f = 0; f < k.length; f++) b = k[f], "outside" === b.stripLine.labelPlacement && b.stripLine.showOnTop && b.textBlock.render(!0) }, b.textBlock)) : "outside" === b.stripLine.labelPlacement && b.textBlock.render(!0)
        }
    };
    ...
    na.prototype.render = function() {
        ...
        if (0 < d) {
            ...
            else if ("left" === this.parent._position || "right" === this.parent._position) h = l = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0, f = this.chart.plotArea.x1, g = this.chart.plotArea.x2, this.bounds = { x1: f, y1: h - d / 2, x2: g, y2: l + d / 2 };
            this.ctx.moveTo(f, h);
            this.ctx.lineTo(g, l);
            this.ctx.stroke();
        ...
        if (!this.chart.disableToolTip) {
            ...
            if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if (this.chart.axisX)
                        for (l = 0; l < this.chart.axisX.length; l++)
                            for (h = this.chart.axisX[l].convertPixelToValue({ x: a }), k = null, c = 0; c < this.chart.axisX[l].dataSeries.length; c++)(k = this.chart.axisX[l].dataSeries[c].getDataPointAtX(h, b)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[l].dataSeries[c], null !== k.dataPoint.y && f.push(k));
                    if (this.chart.axisX2)
                        for (l = 0; l < this.chart.axisX2.length; l++)
                            for (h =
                ...
                if (k = this.chart.getDataPointAtXY(a, d, b)) this.currentDataPointIndex =
                    ...
                    if (k = La(a, d, this.chart._eventManager.ghostCtx), 0 < k && "undefined" !== typeof this.chart._eventManager.objectMap[k]) { k = this.chart._eventManager.objectMap[k];
                    ...
                    if (!x(k.dataPoint.y))
                        if (k.dataSeries.axisY)
                            if (0 < k.dataPoint.y.length) {
                                ...
                                b < k.dataPoint.y.length && b > -k.dataPoint.y.length && g.push(k) } else "column" === f.type || "bar" === f.type ? 0 > k.dataPoint.y ? 0 > k.dataSeries.axisY.viewportMinimum && k.dataSeries.axisY.viewportMaximum >= k.dataPoint.y && g.push(k) : k.dataSeries.axisY.viewportMinimum <=
    ...
    S.prototype.getToolTipInnerHTML = function(a) {
        ...
        for (var h = !0, l = 0; l < d.length; l++)
            if (d[l].dataSeries.toolTipContent || d[l].dataPoint.toolTipContent) { h = !1;
                break }
    ...
    var F = {
        ...
        Oa = {
            Chart: A,
            addColorSet: function(a, d) { ha[a] = d },
            addCultureInfo: function(a, d) { pa[a] = d },
